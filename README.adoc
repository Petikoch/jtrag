...
* At the moment jtrag/jtwfg support only simple, synchronous dependencies.
* jtrag doesn't fully encapsulate jtwfg at the moment. Therefore you need to program using the jtrag *and* the https://github.com/Petikoch/jtwfg[jtwfg] API and understand both of them.
...
But: A "task resource assignment graph" API is more intuitive to use *if* you have tasks *and* resources in your domain model.
Therefore jtrag is a valid extension to https://github.com/Petikoch/jtwfg[jtwfg].
